            ...
            <div class="row">               
                ...
                <div class="col-xl-4 col-xs-12">
                    <div class="card-box items">
                       <div class="century" style="font-size: 20px;color: #333">Send Energy Credits to another  address</div>
                          <div class="century" style="font-size: 15px;color: #666">You can now Send  <b style="color: #ddd">Energy credits</b> From Below.</div>
                          <hr style="opacity: 1" />
                          <div style="padding: 10px;"></div>
                           ...
                           <form method="POST" action="send_energy_credits_handle.php">
                              <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="to_address" id="to_address"  placeholder="Enter KEM Token Address address">
                                <div id="kanam"></div>
                             </div>
                             ...
                             <div class="form-group" >
                                ...
                                <input type="number" min="0" class="form-control"  step=".0001" name="token_no" max="<?php echo $maya['energy_credits']; ?>"  placeholder="Enter No. of KEM Token to Send">
                             </div>
                    ...
                    <div class="card-box items">
                        <h4 class="header-title m-t-0 m-b-20">How energy Credit Trading Works</h4>
                         ...
                         <p>Wholesale electricity and natural gas are traded as commodities, much like corn or copper and other minerals. Commodity markets are frequently volatile, Energy prices are regulated and set by a tariff, the price of energy bought and sold in the wholesale marketplace can change often, and at times dramatically.<br/><br/>
                          ...
                          To move energy across markets, traders and marketers must purchase transmission and gas transportation rights/space from transmission providers and pipeline owners respectively. The movement of electricity, this means purchases of transmission space from   high-voltage transmission system.  Such transmission space becomes available from time to time when Market doesn’t require it to meet the needs of its customers.<br/><br/>

                        As a participant in these energy markets, Khalid's Energy Market buys and sells physical electricity and natural gas at market-based rates with a wide variety of energy suppliers and buyers across UK. We also hold transmission and gas transportation space to get the energy from where it is produced to our customers.</p>
                    </div>
                </div><!-- end col-->
