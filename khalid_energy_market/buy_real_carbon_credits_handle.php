<?php session_start();
    ...
    if($_REQUEST['sxt_amount']==""){
      redirectTo("buy_carbon_credits.php","error","KEM Amount or Tokens cant be Less than Zero");
      exit();
    }
    if($_REQUEST['amount']==""){
    ...
    $table = "transfer";
    $from_address = "0xAf55F3B7DC65c8f9577cf00C8C5CA7b6E8Cc4433 : KEM ADMIN";
    ...
    $value_list.="'Success',";
    $value_list.="'Spent to Buy Carbon Credits',";   
    $value_list.="'KEM'";   
    try {
