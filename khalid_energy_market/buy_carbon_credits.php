            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Buy Carbon Credits</h4>
            ...
            <div class="row">               
                ...
                <div class="col-xl-3 col-md-6 col-xs-12">
                    <div class="card-box items">
                       ...
                       <h4 class="page-title">Buy Carbon Credits</h4>
                       <span>You have a ballance of </span>
                       <hr/>
                       <form action="buy_real_carbon_credits_handle.php" method="POST">
                     ...
                     <div style="padding: 10px;">
                       ...
                       <div class="form-group">
                         ...
                         <input type="number" name="amount" readonly="" value="000" id="amount" min="0" class="form-control" placeholder="Enter Carbon Credits Here">
                       </div>
                        ...
                        <div class="form-group">
                         <button type="submit" class="btn btn-primary" > Buy Carbon Credits </button>
                       </div>
                     </div>
                   </form>                      
                   </div>
