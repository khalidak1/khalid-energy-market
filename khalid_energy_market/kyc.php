                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li>
                                <a href="#" style="text-transform: capitalize;"><?php echo $pdo_auth['name']; ?></a>
                            </li>
                            <li class="active">
                               KYC
                            </li>
                ...
                <div class="col-xl-4 col-xs-12">
                    <div class="card-box items">
                      <div style="padding:10px"></div>               
                        ...
                        <div class="century" style="font-size: 13px;color: #222">You Must Upload a Government Authorised   <b style="color: red">Document</b> For Trading in KEM Tokens</div>
                    ...
                    <div class="card-box items">
                      <div style="padding: 10px;"></div>
                       <div class="century" style="font-size: 20px;color: #55b3dd"> KYC Documents Rules</div>
                          <div class="century" style="font-size: 15px;color: #848d98">Know Your Customer - KYC enables Khalids Energy Market to know/ understand their customers and their financial dealings, to be able to serve them better and manage its risks prudently.</div>
