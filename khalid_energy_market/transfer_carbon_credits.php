            ...
            <div class="row">               
                ...
                <div class="col-xl-4 col-xs-12">
                    <div class="card-box items">
                       <div class="century" style="font-size: 24px;color: #333">Send Carbon Credeits to another address</div>
                          <div class="century" style="font-size: 15px;color: #666">You can now Send  <b style="color: #ddd">Carbon Credits</b> From Below.</div>
                          <hr style="opacity: 1" />
                          <div style="padding: 10px;"></div>
                           ...
                           <form method="POST" action="send_carbon_credits_handle.php">
                              <div class="form-group" >
                                <label>Enter KEM Token Address</label>
                                <input type="text" class="form-control" name="to_address"  placeholder="Enter KEM Token Address address">
                             </div>
                            
                             <div class="form-group" >
                                <label>Your KEM Token Address</label>
                             ...
                             <div class="form-group" >
                                ...
                                <input type="number" min="0" class="form-control"  step=".0001" name="token_no" max="<?php echo $maya['carbon_credits']; ?>"  placeholder="Enter No. of KEM Token to Send">
                             </div>
