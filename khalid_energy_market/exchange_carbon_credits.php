            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Exchange Carbon Credits</h4>
            ...
            <div class="row">               
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card-box items">
                       ...
                       <hr/>
                       <form action="exchange_carbon_credits_handle.php" method="POST">

                     <div style="padding: 10px;">

                       <div class="form-group">
                         <label> Carbon Credits to exchange </label>
                         <input type="number" name="amount" value="000" id="amount" min="0" step="1" class="form-control" placeholder="Enter Carbon Credits Here">
                       </div>

                        <div class="form-group">
                         <label>Amount of KEM you will get </label>
                        ...
                        <div class="form-group">
                         <button type="submit" class="btn btn-primary" > Exchange Carbon Credits </button>
                       </div>
                     </div>
                   </form>                      
                   </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                   <div class="card-box items" style="text-align: center;">
                    <div style="padding: 13px;"></div>
                      ...
                      <h2 style="font-size: 27px;"><?php echo $pdo_auth['balance'];  ?></h2>
                      <hr>

                      <div>Total Carbon Credits Ballance</div>
                      <h2 style="font-size: 27px;"><?php echo $pdo_auth['carbon_credits'];  ?></h2>  
                      <hr>

                      <div>Total Energy Units</div>
                      <h2 style="font-size: 27px;"><?php echo $pdo_auth['energy_credits'];  ?></h2>                      
                   </div>
                </div>
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="card-box items">

                        <h4 class="header-title m-t-0 m-b-10">RECENT Carbon Credits Exchanges</h4>
