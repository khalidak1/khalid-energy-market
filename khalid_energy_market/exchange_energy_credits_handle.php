<?php session_start();
    ...
    if($_REQUEST['sxt_amount']==""){
      redirectTo("exchange_energy_credits.php","error","KEM Amount or Tokens cant be Less than Zero");
      exit();
    }
    if($_REQUEST['amount']==""){
     ...
     if($_REQUEST['amount']>$pdo_auth['energy_credits']){
      redirectTo("exchange_energy_credits.php","error","You Cant Exchange a Greater amount of Energy Credits From What you have");
      exit();
    }
    ...
    $table = "transfer";
    $to_address = "0xAf55F3B7DC65c8f9577cf00C8C5CA7b6E8Cc4433 : KEM ADMIN";
